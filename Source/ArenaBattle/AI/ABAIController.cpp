...
{
	UBlackboardComponent* BlackboardPtr = Blackboard.Get();			// Blackboard : AIController에 멤버 변수로 선언되어 있습니다.
...
{
	UBehaviorTreeComponent* BTComponent = Cast<UBehaviorTreeComponent>(BrainComponent);		// BrainComponent : AIController에 멤버 변수로 선언되어 있습니다.
	if (BTComponent)
	{
